...
(function() {
  $(function() {
    ...
    $(".preference-button #cc_button").on("click", function() {
      $(".preference-button").hide();
      return $("#card-form").toggle();
    });
    $(".preference-button #bank_button").on("click", function() {
      $(".preference-button").hide();
      return $("#bank-account-form").toggle();
    });
    $("input#cc_number").payment("formatCardNumber");
    $("input#cvc").payment("formatCardCVC");
    return $("input#expiration").payment("formatCardExpiry");
  });
